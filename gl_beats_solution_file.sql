...
SELECT COUNT(*) as 'no_of_customers_'
FROM customers;
...
SELECT *
FROM invoice
WHERE billing_city = 'Berlin' or billing_city = 'Paris' AND invoice_date = 2009-02-01;
...
SELECT Customer_country, Count(customer_id) as 'count_of_customers'
FROM customers
